...
A nice tool to visualize all the outputs of the step by step R notebook is availeble [here](https://nbviewer.org/github/shaupert/HAUPERT_2022/blob/master/scripts/step_by_step/step_by_step.ipynb)
