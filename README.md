# Haupert S. & al. Physics-based model to predict the acoustic detection distance variation of autonomous recorder units: insights from an Alpine and a Neotropical forest. Journal to be defined (XXXX)
